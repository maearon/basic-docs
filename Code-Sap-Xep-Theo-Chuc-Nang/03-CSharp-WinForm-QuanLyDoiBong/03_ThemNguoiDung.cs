...
{
    public partial class ThemND : Form
    {
        public ThemND()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand themnguoidung = new SqlCommand("INSERT INTO test VALUES('" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + comboBox1.SelectedItem.ToString() + "')");

...
{
    public partial class SuaHLV : Form
    {
        public SuaHLV()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (textBox1.Text != "" & textBox2.Text != "" & textBox3.Text != "" & textBox4.Text != "" & textBox5.Text != "")
                {
                    ...
                    SqlCommand themnguoidung = new SqlCommand("update hlv set vaitro='" + textBox1.Text + "',hoten='" + textBox2.Text + "',ngaysinh='" + textBox3.Text + "' gioitinh='" + textBox4.Text + "' quoc tich='" + textBox5.Text + "' where vaitro='" + textBox1.Text + "'");

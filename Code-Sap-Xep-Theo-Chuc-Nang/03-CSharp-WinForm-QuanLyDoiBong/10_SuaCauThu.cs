...
{
    public partial class SuaCT : Form
    {
        public SuaCT()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (textBox1.Text != "" & textBox2.Text != "" & textBox3.Text != "" & textBox4.Text != "")
                {
                    ...
                    SqlCommand themnguoidung = new SqlCommand("update cau thu set soao='" + textBox1.Text + "',hoten='" + textBox2.Text + "',ngaysinh='" + textBox3.Text + "' quoctich='" + textBox4.Text + "' where soao='" + textBox1.Text + "'");

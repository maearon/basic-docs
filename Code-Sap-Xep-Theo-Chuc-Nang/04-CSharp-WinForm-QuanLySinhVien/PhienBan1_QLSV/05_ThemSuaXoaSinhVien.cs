...
namespace WindowsFormsApplication7
{
    public partial class themsuaxoa : Form
    {
        ...
        private void XoaND_Load(object sender, EventArgs e)
        {
            laymakhoa();
            laybangsinhvien();
        }
        ...
        private void cmdthem_Click(object sender, EventArgs e)
        {
            ...
            {
                KetNoi kn = new KetNoi();
                int kq = kn.xulydulieu("insert into tablesinhvien(hoten,masv,khoa,gioitinh,ngaysinh,diachi,sdt,lop) values (N'" + txthoten.Text + "','" + txtmasv.Text + "','" + cbkhoa.Text + "',N'" + cbgioitinh.Text + "','" + dtngaysinh.Text + "',N'" + txtdiachi.Text + "','" + txtsdt.Text + "', '" + txtlop.Text + "')");
                if (kq > 0)
                {
        ...
        private void cmdsua_Click(object sender, EventArgs e)
        {
            ...
            {
                KetNoi kn = new KetNoi();
                int kq = kn.xulydulieu("update tablesinhvien set hoten=N'" + txthoten.Text + "', khoa='" + cbkhoa.Text + "', gioitinh=N'" + cbgioitinh.Text + "', ngaysinh='" + dtngaysinh.Text + "', diachi=N'" + txtdiachi.Text + "', sdt='" + txtsdt.Text + "', lop='" + txtlop.Text + "' where masv='" + txtmasv.Text + "'");
                if (kq > 0)
                {
        ...
        private void GridViewDSSV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                txtlop.Text = row.Cells[7].Value.ToString();
            }
            catch
            {
